...
@section('title', trans_common('sales_reports'))

@section('content_header')
    <h1>{{ trans_common('sales_reports') }}</h1>
@stop

@section('content')
    <x-adminlte-card title="{{ trans_common('sales_reports') }}" theme="primary" icon="fas fa-chart-line">
        ...
        @if(isset($summary))
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <x-adminlte-info-box title="{{ trans_common('average_sale') }}" 
                                         text="{{ currency_format($summary['average'] ?? 0) }}" 
