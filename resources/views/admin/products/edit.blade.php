...
@section('title', trans_common('edit') . ' ' . trans_common('products'))

@section('content_header')
    <h1>{{ trans_common('edit') }} {{ trans_common('products') }}</h1>
@stop

@section('content')
    <x-adminlte-card title="{{ trans_common('edit') }} {{ trans_common('products') }}" theme="primary" icon="fas fa-box">
            ...
            <div class="row">
                <div class="col-md-6">
                    <x-adminlte-input name="fabric_width" 
                                      ...
                                      value="{{ old('fabric_width', $product->fabric_width) }}" />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="vat_type" class="form-control">
                            <option value="inclusive" {{ old('vat_type', $product->vat_type) == 'inclusive' ? 'selected' : '' }}>
                                Inclusive
                            </option>
                            <option value="exclusive" {{ old('vat_type', $product->vat_type) == 'exclusive' ? 'selected' : '' }}>
                                Exclusive
                            </option>
                        </select>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <x-adminlte-input name="qr_code" 
                                      ...
                                      value="{{ old('qr_code', $product->qr_code) }}" />
                </div>
            </div>
                    ...
                    @if($product->sizes->count() > 0)
                        @foreach($product->sizes as $size)
                            <div class="input-group mb-2">
                                <input type="text" name="sizes[]" class="form-control" value="{{ $size->size }}" placeholder="Enter size">
