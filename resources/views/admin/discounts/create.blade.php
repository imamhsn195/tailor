...
@section('title', trans_common('create') . ' ' . trans_common('discount'))

@section('content_header')
    <h1>{{ trans_common('create') }} {{ trans_common('discount') }}</h1>
@stop

@section('content')
    <x-adminlte-card title="{{ trans_common('create') }} {{ trans_common('discount') }}" theme="primary" icon="fas fa-percent">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="applicable_to" class="form-control" id="applicable_to">
                            <option value="">{{ trans_common('select_an_option') }}</option>
                            <option value="customer_id" {{ old('applicable_to') == 'customer_id' ? 'selected' : '' }}>{{ trans_common('customer') }}</option>
                            <option value="membership" {{ old('applicable_to') == 'membership' ? 'selected' : '' }}>{{ trans_common('membership') }}</option>
                            <option value="product" {{ old('applicable_to') == 'product' ? 'selected' : '' }}>{{ trans_common('product') }}</option>
                            <option value="company" {{ old('applicable_to') == 'company' ? 'selected' : '' }}>{{ trans_common('company') }}</option>
                        </select>
                    </div>
                </div>
            </div>
