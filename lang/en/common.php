...
return [
    ...
    'no_log_files_detected' => 'No log files detected',
    'no_log_files_found' => 'No log files were found under <code>storage/logs</code>. New log files will appear as soon as the application starts writing logs.',
    'refresh' => 'Refresh',
    'channel' => 'Channel',
    ...
    'entries_to_display' => 'Entries to display',
    'latest_entries' => 'Latest Entries',
    'showing_entries' => 'Showing {count} / {per_page} entries (scanned {files} files)',
    'timestamp' => 'Timestamp',
    'channel_file' => 'Channel / File',
    'message_context' => 'Message & Context',
    'expand_details' => 'Expand details',
    'no_log_entries_found' => 'No log entries found for the selected filters.',
    'loading_logs' => 'Loading logs...',
    'unable_to_load_logs' => 'Unable to load logs. Please try again.',
    'delete_log_entry_confirm' => 'Are you sure you want to delete this log entry? This action cannot be undone.',
    'delete_log_entry' => 'Delete this log entry',
    'delete_selected' => 'Delete Selected',
    'delete_selected_logs_confirm' => 'Are you sure you want to delete {count} selected log entry/entries? This action cannot be undone.',
    'no_files_for_channel' => 'No files for this channel',
    'log_entry_deleted_successfully' => 'Log entry has been deleted successfully.',
    'log_entries_deleted_successfully' => '{count} log entry/entries have been deleted successfully.',
    'some_log_entries_deleted' => '{deleted} log entry/entries deleted successfully, but {failed} failed to delete.',
    'unable_to_delete_log_entry' => 'Unable to delete the log entry. The entry may not exist or you don\'t have permission.',
    'unable_to_delete_log_entries' => 'Unable to delete the log entries. Some entries may not exist or you don\'t have permission.',
    'context' => 'Context',
    'message' => 'Message',
    'apply' => 'Apply',
    'clear' => 'Clear',
